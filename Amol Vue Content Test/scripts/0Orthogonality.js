...
setTimeout(function () {main()}, 5000); //Load main when document is ready.

// checker = document.querySelectorAll(".journey")[0];

// checker.addEventListener(scroll, console.log("test"));