        ...
        methods: {
            OnScroll: function (event) {
                ...
                if (this.scrolling < pg_heights[0]) {
                    progress_buttons[0].style = "background-color: rgba(170,55,88,0.7); color: white;";
                    progress_buttons[1].style = "background-color: transparent; color: black;";
                    progress_buttons[2].style = "background-color: transparent; color: black;";
                    progress_buttons[3].style = "background-color: transparent; color: black;";
                } else if (this.scrolling<pg_heights[1]) {
                    progress_buttons[0].style = "background-color: transparent; color: black;";
                    progress_buttons[1].style = "background-color: rgba(170,55,88,0.7); color: white;";
                    progress_buttons[2].style = "background-color: transparent; color: black;";
                    progress_buttons[3].style = "background-color: transparent; color: black;";
                } else if (this.scrolling<pg_heights[2]) {
                    progress_buttons[0].style = "background-color: transparent; color: black;";
                    progress_buttons[1].style = "background-color: transparent; color: black;";
                    progress_buttons[2].style = "background-color: rgba(170,55,88,0.7); color: white;";
                    progress_buttons[3].style = "background-color: transparent; color: black;";
                } else if (this.scrolling<pg_heights[3]) {
                    progress_buttons[0].style = "background-color: transparent; color: black;";
                    progress_buttons[1].style = "background-color: transparent; color: black;";
                    progress_buttons[2].style = "background-color: transparent; color: black;";
                    progress_buttons[3].style = "background-color: rgba(170,55,88,0.7); color: white;";
                }
            },
