...
function computeBasis(x1, y1,x2,y2 , x3,y3) {
    ...
    ;
    //document.getElementById('vectorComponents').textContent = scale1+' x vector1 & '+scale2+' x vector2'
...
function initCarte(type) {
    ...
    /* ~Jquery,  changed to native JS
    1.  Assign initial/default x, y values to the sliders and slider displays.
    */
    //document.getElementById('x1Controller').value = initX1
    $("#x1Controller").val(initX1);
    //document.getElementById('x1ControllerDisplay').value = initX1
    $("#x1ControllerDisplay").val(initX1);
    //document.getElementById('y1Controller').value = initY1
    $("#y1Controller").val(initY1);
    //document.getElementById('y1ControllerDisplay').value = initY1
    $("#y1ControllerDisplay").val(initY1);

    //document.getElementById('x2Controller').value = initX2
    $("#x2Controller").val(initX2);
    //document.getElementById('x2ControllerDisplay').value = initX2
    $("#x2ControllerDisplay").val(initX2);
    //document.getElementById('y2Controller').value = initY2
    $("#y2Controller").val(initY2);
    //document.getElementById('y2ControllerDisplay').value = initY2
    $("#y2ControllerDisplay").val(initY2);

    //document.getElementById('x3Controller').value = initX3
    $("#x3Controller").val(initX3);
    //document.getElementById('x3ControllerDisplay').value = initX3
    $("#x3ControllerDisplay").val(initX3);
    //document.getElementById('y3Controller').value = initY3
    $("#y3Controller").val(initY3);
    //document.getElementById('y3ControllerDisplay').value = initY3
...
function main_0() {
    ...
    $("input[type=range]").each(function () {
        ...
        $(this).on('input', function(){
            ...
            updatePlot_0(); //Updating the plot is linked with display (Just My preference)
        });
    ...
    initCarte("#basis");
    updatePlot_0(); //Shows initial positions of vectors
    }

$(document).ready(main_0); //Load main when document is ready.